# AGENTS.md instructions for c:\Users\User\Desktop\projects\mamaPack
...
- Перед изменениями читай `PROJECT_PLAN.md`: там короткая карта проекта и актуальные рабочие потоки.
