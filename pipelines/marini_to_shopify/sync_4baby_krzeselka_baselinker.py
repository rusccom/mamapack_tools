...
SOURCE_REPORT = Path(__file__).with_name("forbaby_krzeselka_15_shopify_sync_report.json")
REPORT_DIR = ROOT / "store_reports" / "baselinker" / "2026-05-09"
REPORT_PATH = REPORT_DIR / "forbaby_krzeselka_baselinker_create_link_20260509.json"
PARENT_CATEGORY_ID = 2920334
CATEGORY_NAME = "Krzesełka do karmienia"
